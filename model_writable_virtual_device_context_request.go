...
func (o *WritableVirtualDeviceContextRequest) UnmarshalJSON(bytes []byte) (err error) {
	varWritableVirtualDeviceContextRequest := _WritableVirtualDeviceContextRequest{}

	if err = json.Unmarshal(bytes, &varWritableVirtualDeviceContextRequest); err == nil {
