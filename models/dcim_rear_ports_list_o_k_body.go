...
func (m *DcimRearPortsListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *DcimRearPortsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimRearPortsListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *DcimRearPortsListOKBody) validateResults(formats strfmt.Registry) error {
