...
func (o *PaginatedDeviceWithConfigContextList) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedDeviceWithConfigContextList := _PaginatedDeviceWithConfigContextList{}

	if err = json.Unmarshal(bytes, &varPaginatedDeviceWithConfigContextList); err == nil {
