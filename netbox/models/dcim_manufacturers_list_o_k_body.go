...
func (m *DcimManufacturersListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimManufacturersListOKBody) validatePrevious(formats strfmt.Registry) error {
