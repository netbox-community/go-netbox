...
/*DcimFrontPortTemplatesBulkUpdateOK handles this case with default header values.
...
/*DcimFrontPortTemplatesBulkUpdateDefault handles this case with default header values.
