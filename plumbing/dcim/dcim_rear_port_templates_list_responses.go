...
type DcimRearPortTemplatesListOK struct {
	Payload *models.DcimRearPortTemplatesListOKBody
}
...
func (o *DcimRearPortTemplatesListOK) GetPayload() *models.DcimRearPortTemplatesListOKBody {
	return o.Payload
}
...
func (o *DcimRearPortTemplatesListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DcimRearPortTemplatesListOKBody)
