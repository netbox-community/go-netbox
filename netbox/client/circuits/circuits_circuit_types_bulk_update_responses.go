...
/*CircuitsCircuitTypesBulkUpdateOK handles this case with default header values.
...
/*CircuitsCircuitTypesBulkUpdateDefault handles this case with default header values.
