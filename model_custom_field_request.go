...
// SetChoiceSet gets a reference to the given NestedCustomFieldChoiceSetRequest and assigns it to the ChoiceSet field.
...
func (o *CustomFieldRequest) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCustomFieldRequest)
