...
/*DcimDevicesBulkPartialUpdateOK handles this case with default header values.
...
/*DcimDevicesBulkPartialUpdateDefault handles this case with default header values.
