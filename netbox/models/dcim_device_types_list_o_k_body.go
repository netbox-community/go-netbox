...
func (m *DcimDeviceTypesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimDeviceTypesListOKBody) validatePrevious(formats strfmt.Registry) error {
