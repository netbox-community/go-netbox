...
/*DcimInterfaceTemplatesBulkPartialUpdateOK handles this case with default header values.
...
/*DcimInterfaceTemplatesBulkPartialUpdateDefault handles this case with default header values.
