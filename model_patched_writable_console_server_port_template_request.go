...
func (o *PatchedWritableConsoleServerPortTemplateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPatchedWritableConsoleServerPortTemplateRequest := _PatchedWritableConsoleServerPortTemplateRequest{}

	if err = json.Unmarshal(bytes, &varPatchedWritableConsoleServerPortTemplateRequest); err == nil {
