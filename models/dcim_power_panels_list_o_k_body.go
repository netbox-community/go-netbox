...
func (m *DcimPowerPanelsListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *DcimPowerPanelsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimPowerPanelsListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *DcimPowerPanelsListOKBody) validateResults(formats strfmt.Registry) error {
