...
func (m *DcimPowerFeedsListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *DcimPowerFeedsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimPowerFeedsListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *DcimPowerFeedsListOKBody) validateResults(formats strfmt.Registry) error {
