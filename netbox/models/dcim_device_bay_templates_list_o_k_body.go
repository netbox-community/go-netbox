...
func (m *DcimDeviceBayTemplatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimDeviceBayTemplatesListOKBody) validatePrevious(formats strfmt.Registry) error {
