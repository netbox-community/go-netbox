...
type ApiWirelessWirelessLinksListRequest struct {
	...
	distanceUnitN     *WirelessWirelessLinksListDistanceUnitParameter
	id                *[]int32
	idEmpty           *bool
	idGt              *[]int32
	idGte             *[]int32
...
// * &#x60;km&#x60; - Kilometers * &#x60;m&#x60; - Meters * &#x60;mi&#x60; - Miles * &#x60;ft&#x60; - Feet
func (r ApiWirelessWirelessLinksListRequest) DistanceUnitN(distanceUnitN WirelessWirelessLinksListDistanceUnitParameter) ApiWirelessWirelessLinksListRequest {
...
func (a *WirelessAPIService) WirelessWirelessLinksListExecute(r ApiWirelessWirelessLinksListRequest) (*PaginatedWirelessLinkList, *http.Response, error) {
	...
	if r.distanceUnitN != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "distance_unit__n", r.distanceUnitN, "")
	}
	if r.id != nil {
		t := *r.id
		if reflect.TypeOf(t).Kind() == reflect.Slice {
