...
/*DcimInterfacesBulkPartialUpdateOK handles this case with default header values.
...
/*DcimInterfacesBulkPartialUpdateDefault handles this case with default header values.
