...
func (m *DcimFrontPortTemplatesListOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DcimFrontPortTemplatesListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *DcimFrontPortTemplatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimFrontPortTemplatesListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *DcimFrontPortTemplatesListOKBody) validateResults(formats strfmt.Registry) error {
