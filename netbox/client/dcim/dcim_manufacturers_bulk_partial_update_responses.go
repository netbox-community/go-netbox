...
/*DcimManufacturersBulkPartialUpdateOK handles this case with default header values.
...
/*DcimManufacturersBulkPartialUpdateDefault handles this case with default header values.
