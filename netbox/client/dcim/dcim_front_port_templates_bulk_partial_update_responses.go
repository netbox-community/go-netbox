...
/*DcimFrontPortTemplatesBulkPartialUpdateOK handles this case with default header values.
...
/*DcimFrontPortTemplatesBulkPartialUpdateDefault handles this case with default header values.
