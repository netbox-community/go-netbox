...
func (m *DcimConsoleServerPortsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimConsoleServerPortsListOKBody) validatePrevious(formats strfmt.Registry) error {
