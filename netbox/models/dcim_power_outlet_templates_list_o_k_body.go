...
func (m *DcimPowerOutletTemplatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimPowerOutletTemplatesListOKBody) validatePrevious(formats strfmt.Registry) error {
