...
func (m *DcimFrontPortsListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *DcimFrontPortsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimFrontPortsListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *DcimFrontPortsListOKBody) validateResults(formats strfmt.Registry) error {
