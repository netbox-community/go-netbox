...
/*DcimRackRolesBulkPartialUpdateOK handles this case with default header values.
...
/*DcimRackRolesBulkPartialUpdateDefault handles this case with default header values.
