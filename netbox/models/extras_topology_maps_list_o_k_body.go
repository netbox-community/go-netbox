...
type ExtrasTopologyMapsListOKBody struct {
	...
	// results
	// Required: true
	Results []*TopologyMap `json:"results"`
}
...
func (m *ExtrasTopologyMapsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *ExtrasTopologyMapsListOKBody) validatePrevious(formats strfmt.Registry) error {
