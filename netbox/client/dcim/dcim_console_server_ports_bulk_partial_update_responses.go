...
/*DcimConsoleServerPortsBulkPartialUpdateOK handles this case with default header values.
...
/*DcimConsoleServerPortsBulkPartialUpdateDefault handles this case with default header values.
