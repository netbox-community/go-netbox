...
type ExtrasRecentActivityListOKBody struct {
	...
	// results
	// Required: true
	Results []*UserAction `json:"results"`
}
...
func (m *ExtrasRecentActivityListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *ExtrasRecentActivityListOKBody) validatePrevious(formats strfmt.Registry) error {
