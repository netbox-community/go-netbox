...
func (m *DcimConsolePortsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimConsolePortsListOKBody) validatePrevious(formats strfmt.Registry) error {
