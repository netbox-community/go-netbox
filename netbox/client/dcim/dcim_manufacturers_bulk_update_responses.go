...
/*DcimManufacturersBulkUpdateOK handles this case with default header values.
...
/*DcimManufacturersBulkUpdateDefault handles this case with default header values.
