...
func (m *DcimInterfaceConnectionsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimInterfaceConnectionsListOKBody) validatePrevious(formats strfmt.Registry) error {
