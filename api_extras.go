...
func (r ApiExtrasWebhooksListRequest) ContentTypeIdEmpty(contentTypeIdEmpty []int32) ApiExtrasWebhooksListRequest {
	r.contentTypeIdEmpty = &contentTypeIdEmpty
	return r
}
...
func (r ApiExtrasWebhooksListRequest) PayloadUrlEmpty(payloadUrlEmpty bool) ApiExtrasWebhooksListRequest {
...
func (a *ExtrasAPIService) ExtrasWebhooksListExecute(r ApiExtrasWebhooksListRequest) (*PaginatedWebhookList, *http.Response, error) {
	...
	if r.payloadUrlEmpty != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "payload_url__empty", r.payloadUrlEmpty, "")
	}
