...
func (m *DcimConsolePortTemplatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimConsolePortTemplatesListOKBody) validatePrevious(formats strfmt.Registry) error {
