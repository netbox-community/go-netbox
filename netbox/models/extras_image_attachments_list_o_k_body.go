...
func (m *ExtrasImageAttachmentsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *ExtrasImageAttachmentsListOKBody) validatePrevious(formats strfmt.Registry) error {
