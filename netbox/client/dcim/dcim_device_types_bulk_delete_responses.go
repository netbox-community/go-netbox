...
/*DcimDeviceTypesBulkDeleteNoContent handles this case with default header values.
...
/*DcimDeviceTypesBulkDeleteDefault handles this case with default header values.
