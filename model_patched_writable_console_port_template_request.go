...
func (o *PatchedWritableConsolePortTemplateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPatchedWritableConsolePortTemplateRequest := _PatchedWritableConsolePortTemplateRequest{}

	if err = json.Unmarshal(bytes, &varPatchedWritableConsolePortTemplateRequest); err == nil {
