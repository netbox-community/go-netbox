...
func (m *VirtualizationClustersListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *VirtualizationClustersListOKBody) validatePrevious(formats strfmt.Registry) error {
