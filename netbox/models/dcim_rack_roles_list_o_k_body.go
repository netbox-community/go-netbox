...
func (m *DcimRackRolesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimRackRolesListOKBody) validatePrevious(formats strfmt.Registry) error {
