...
func (m *DcimPlatformsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimPlatformsListOKBody) validatePrevious(formats strfmt.Registry) error {
