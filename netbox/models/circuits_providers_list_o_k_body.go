...
func (m *CircuitsProvidersListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *CircuitsProvidersListOKBody) validatePrevious(formats strfmt.Registry) error {
