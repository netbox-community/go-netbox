...
func (m *VirtualizationClusterTypesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *VirtualizationClusterTypesListOKBody) validatePrevious(formats strfmt.Registry) error {
