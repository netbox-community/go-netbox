...
/*DcimRackGroupsBulkDeleteNoContent handles this case with default header values.
...
/*DcimRackGroupsBulkDeleteDefault handles this case with default header values.
