...
func (o *PatchedWritablePowerPortTemplateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPatchedWritablePowerPortTemplateRequest := _PatchedWritablePowerPortTemplateRequest{}

	if err = json.Unmarshal(bytes, &varPatchedWritablePowerPortTemplateRequest); err == nil {
