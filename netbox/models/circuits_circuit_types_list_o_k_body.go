...
func (m *CircuitsCircuitTypesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *CircuitsCircuitTypesListOKBody) validatePrevious(formats strfmt.Registry) error {
