...
func (m *DcimRearPortTemplatesListOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DcimRearPortTemplatesListOKBody) validateCount(formats strfmt.Registry) error {
...
func (m *DcimRearPortTemplatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimRearPortTemplatesListOKBody) validatePrevious(formats strfmt.Registry) error {
...
func (m *DcimRearPortTemplatesListOKBody) validateResults(formats strfmt.Registry) error {
