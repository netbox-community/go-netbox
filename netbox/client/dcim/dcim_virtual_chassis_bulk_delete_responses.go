...
/*DcimVirtualChassisBulkDeleteNoContent handles this case with default header values.
...
/*DcimVirtualChassisBulkDeleteDefault handles this case with default header values.
