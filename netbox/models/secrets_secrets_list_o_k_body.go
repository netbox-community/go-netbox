...
func (m *SecretsSecretsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *SecretsSecretsListOKBody) validatePrevious(formats strfmt.Registry) error {
