...
type DcimFrontPortTemplatesListOK struct {
	Payload *models.DcimFrontPortTemplatesListOKBody
}
...
func (o *DcimFrontPortTemplatesListOK) GetPayload() *models.DcimFrontPortTemplatesListOKBody {
	return o.Payload
}
...
func (o *DcimFrontPortTemplatesListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DcimFrontPortTemplatesListOKBody)
