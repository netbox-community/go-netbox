...
func (m *DcimConsoleServerPortTemplatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimConsoleServerPortTemplatesListOKBody) validatePrevious(formats strfmt.Registry) error {
