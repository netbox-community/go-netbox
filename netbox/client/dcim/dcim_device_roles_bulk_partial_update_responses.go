...
/*DcimDeviceRolesBulkPartialUpdateOK handles this case with default header values.
...
/*DcimDeviceRolesBulkPartialUpdateDefault handles this case with default header values.
