...
/*DcimDeviceBayTemplatesBulkDeleteNoContent handles this case with default header values.
...
/*DcimDeviceBayTemplatesBulkDeleteDefault handles this case with default header values.
