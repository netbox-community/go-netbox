...
/*DcimPowerOutletTemplatesBulkPartialUpdateOK handles this case with default header values.
...
/*DcimPowerOutletTemplatesBulkPartialUpdateDefault handles this case with default header values.
