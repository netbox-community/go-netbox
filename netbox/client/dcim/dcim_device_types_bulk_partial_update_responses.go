...
/*DcimDeviceTypesBulkPartialUpdateOK handles this case with default header values.
...
/*DcimDeviceTypesBulkPartialUpdateDefault handles this case with default header values.
