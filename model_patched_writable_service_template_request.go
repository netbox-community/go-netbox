...
func (o *PatchedWritableServiceTemplateRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPatchedWritableServiceTemplateRequest := _PatchedWritableServiceTemplateRequest{}

	if err = json.Unmarshal(bytes, &varPatchedWritableServiceTemplateRequest); err == nil {
