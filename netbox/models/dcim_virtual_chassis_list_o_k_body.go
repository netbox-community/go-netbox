...
func (m *DcimVirtualChassisListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimVirtualChassisListOKBody) validatePrevious(formats strfmt.Registry) error {
