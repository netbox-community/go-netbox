...
// WithFamilyn adds the familyn to the ipam prefixes list params
func (o *IpamPrefixesListParams) WithFamilyn(familyn *string) *IpamPrefixesListParams {
	o.SetFamilyn(familyn)
	return o
}

// SetFamilyn adds the familyN to the ipam prefixes list params
func (o *IpamPrefixesListParams) SetFamilyn(familyn *string) {
	o.Familyn = familyn
}
