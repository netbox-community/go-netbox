...
/*DcimFrontPortsBulkDeleteNoContent handles this case with default header values.
...
/*DcimFrontPortsBulkDeleteDefault handles this case with default header values.
