...
func (m *DcimPowerConnectionsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimPowerConnectionsListOKBody) validatePrevious(formats strfmt.Registry) error {
