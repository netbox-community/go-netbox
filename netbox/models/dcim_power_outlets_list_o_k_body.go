...
func (m *DcimPowerOutletsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimPowerOutletsListOKBody) validatePrevious(formats strfmt.Registry) error {
