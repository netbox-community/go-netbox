...
func (m *TenancyTenantGroupsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *TenancyTenantGroupsListOKBody) validatePrevious(formats strfmt.Registry) error {
