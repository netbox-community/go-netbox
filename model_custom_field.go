...
func (o *CustomField) GetUiVisibility() CustomFieldUiVisibility {
	if o == nil || IsNil(o.UiVisibility) {
		var ret CustomFieldUiVisibility
		return ret
	}
...
// SetUiVisibility gets a reference to the given CustomFieldUiVisibility and assigns it to the UiVisibility field.
...
// GetChoiceSet returns the ChoiceSet field value if set, zero value otherwise.
func (o *CustomField) GetChoiceSet() NestedCustomFieldChoiceSet {
	if o == nil || IsNil(o.ChoiceSet) {
...
// SetChoiceSet gets a reference to the given NestedCustomFieldChoiceSet and assigns it to the ChoiceSet field.
