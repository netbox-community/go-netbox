...
/*DcimDeviceRolesBulkDeleteNoContent handles this case with default header values.
...
/*DcimDeviceRolesBulkDeleteDefault handles this case with default header values.
