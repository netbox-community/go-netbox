...
func (m *DcimConsoleConnectionsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimConsoleConnectionsListOKBody) validatePrevious(formats strfmt.Registry) error {
