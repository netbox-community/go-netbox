...
func (m *DcimRackGroupsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimRackGroupsListOKBody) validatePrevious(formats strfmt.Registry) error {
