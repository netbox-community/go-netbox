...
type DcimFrontPortsListOK struct {
	Payload *models.DcimFrontPortsListOKBody
}
...
func (o *DcimFrontPortsListOK) GetPayload() *models.DcimFrontPortsListOKBody {
	return o.Payload
}
...
func (o *DcimFrontPortsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DcimFrontPortsListOKBody)
