...
/*CircuitsCircuitTerminationsBulkDeleteNoContent handles this case with default header values.
...
/*CircuitsCircuitTerminationsBulkDeleteDefault handles this case with default header values.
