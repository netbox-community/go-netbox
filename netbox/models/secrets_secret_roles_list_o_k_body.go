...
func (m *SecretsSecretRolesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *SecretsSecretRolesListOKBody) validatePrevious(formats strfmt.Registry) error {
