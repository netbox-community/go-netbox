...
func (m *DcimDeviceBaysListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimDeviceBaysListOKBody) validatePrevious(formats strfmt.Registry) error {
