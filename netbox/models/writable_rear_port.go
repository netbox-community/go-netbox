...
type WritableRearPort struct {
	...
	// Type
	// Required: true
	// Enum: [1000 1100 1200 2200 2300 2310 2600 2610 2500 2400 2100 2110 2000]
...
func init() {
	var res []int64
	if err := json.Unmarshal([]byte(`[1000,1100,1200,2200,2300,2310,2600,2610,2500,2400,2100,2110,2000]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
