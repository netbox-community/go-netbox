...
func (m *DcimDeviceRolesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimDeviceRolesListOKBody) validatePrevious(formats strfmt.Registry) error {
