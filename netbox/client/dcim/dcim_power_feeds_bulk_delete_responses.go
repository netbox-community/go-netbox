...
/*DcimPowerFeedsBulkDeleteNoContent handles this case with default header values.
...
/*DcimPowerFeedsBulkDeleteDefault handles this case with default header values.
