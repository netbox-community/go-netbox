...
/*DcimRacksBulkPartialUpdateOK handles this case with default header values.
...
/*DcimRacksBulkPartialUpdateDefault handles this case with default header values.
