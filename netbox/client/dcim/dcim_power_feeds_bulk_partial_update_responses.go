...
/*DcimPowerFeedsBulkPartialUpdateOK handles this case with default header values.
...
/*DcimPowerFeedsBulkPartialUpdateDefault handles this case with default header values.
