...
func (m *IPAMVlanGroupsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *IPAMVlanGroupsListOKBody) validatePrevious(formats strfmt.Registry) error {
