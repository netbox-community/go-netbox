...
/*DcimConsoleServerPortsBulkUpdateOK handles this case with default header values.
...
/*DcimConsoleServerPortsBulkUpdateDefault handles this case with default header values.
