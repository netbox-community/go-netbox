...
/*DcimFrontPortTemplatesBulkDeleteNoContent handles this case with default header values.
...
/*DcimFrontPortTemplatesBulkDeleteDefault handles this case with default header values.
