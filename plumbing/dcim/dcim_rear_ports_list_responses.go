...
type DcimRearPortsListOK struct {
	Payload *models.DcimRearPortsListOKBody
}
...
func (o *DcimRearPortsListOK) GetPayload() *models.DcimRearPortsListOKBody {
	return o.Payload
}
...
func (o *DcimRearPortsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DcimRearPortsListOKBody)
