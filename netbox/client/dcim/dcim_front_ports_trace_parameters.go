...
// NewDcimFrontPortsTraceParams creates a new DcimFrontPortsTraceParams object
// with the default values initialized.
func NewDcimFrontPortsTraceParams() *DcimFrontPortsTraceParams {
	var ()
	return &DcimFrontPortsTraceParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDcimFrontPortsTraceParamsWithTimeout creates a new DcimFrontPortsTraceParams object
...
// NewDcimFrontPortsTraceParamsWithContext creates a new DcimFrontPortsTraceParams object
...
// NewDcimFrontPortsTraceParamsWithHTTPClient creates a new DcimFrontPortsTraceParams object
...
for the dcim front ports trace operation typically these are written to a http.Request
*/
...
func (o *DcimFrontPortsTraceParams) WithTimeout(timeout time.Duration) *DcimFrontPortsTraceParams {
...
func (o *DcimFrontPortsTraceParams) WithContext(ctx context.Context) *DcimFrontPortsTraceParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DcimFrontPortsTraceParams) WithID(id int64) *DcimFrontPortsTraceParams {
	o.SetID(id)
	return o
}
...
func (o *DcimFrontPortsTraceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
