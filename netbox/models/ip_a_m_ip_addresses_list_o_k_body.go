...
func (m *IPAMIPAddressesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *IPAMIPAddressesListOKBody) validatePrevious(formats strfmt.Registry) error {
