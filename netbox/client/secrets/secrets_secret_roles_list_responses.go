...
func (o *SecretsSecretRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewSecretsSecretRolesListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewSecretsSecretRolesListDefault creates a SecretsSecretRolesListDefault with default headers values
func NewSecretsSecretRolesListDefault(code int) *SecretsSecretRolesListDefault {
	return &SecretsSecretRolesListDefault{
		_statusCode: code,
	}
}

/* SecretsSecretRolesListDefault describes a response with status code -1, with default header values.

SecretsSecretRolesListDefault secrets secret roles list default
*/
type SecretsSecretRolesListDefault struct {
	_statusCode int

	Payload interface{}
}

// Code gets the status code for the secrets secret roles list default response
func (o *SecretsSecretRolesListDefault) Code() int {
	return o._statusCode
}

func (o *SecretsSecretRolesListDefault) Error() string {
	return fmt.Sprintf("[GET /secrets/secret-roles/][%d] secrets_secret-roles_list default  %+v", o._statusCode, o.Payload)
}
func (o *SecretsSecretRolesListDefault) GetPayload() interface{} {
	return o.Payload
}

func (o *SecretsSecretRolesListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
