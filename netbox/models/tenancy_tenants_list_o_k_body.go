...
func (m *TenancyTenantsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *TenancyTenantsListOKBody) validatePrevious(formats strfmt.Registry) error {
