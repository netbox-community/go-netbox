...
/*DcimConsolePortTemplatesBulkUpdateOK handles this case with default header values.
...
/*DcimConsolePortTemplatesBulkUpdateDefault handles this case with default header values.
