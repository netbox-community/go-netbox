...
func (m *IPAMAggregatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *IPAMAggregatesListOKBody) validatePrevious(formats strfmt.Registry) error {
