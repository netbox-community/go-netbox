...
/*DcimDeviceBayTemplatesBulkUpdateOK handles this case with default header values.
...
/*DcimDeviceBayTemplatesBulkUpdateDefault handles this case with default header values.
