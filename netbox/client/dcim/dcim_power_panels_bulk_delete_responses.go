...
/*DcimPowerPanelsBulkDeleteNoContent handles this case with default header values.
...
/*DcimPowerPanelsBulkDeleteDefault handles this case with default header values.
