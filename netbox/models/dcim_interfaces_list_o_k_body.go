...
func (m *DcimInterfacesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimInterfacesListOKBody) validatePrevious(formats strfmt.Registry) error {
