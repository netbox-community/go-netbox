...
func (o *DcimRearPortsTraceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDcimRearPortsTraceOK()
...
func NewDcimRearPortsTraceOK() *DcimRearPortsTraceOK {
	return &DcimRearPortsTraceOK{}
}

/*DcimRearPortsTraceOK handles this case with default header values.
...
func (o *DcimRearPortsTraceOK) Error() string {
	return fmt.Sprintf("[GET /dcim/rear-ports/{id}/trace/][%d] dcimRearPortsTraceOK  %+v", 200, o.Payload)
}
...
func (o *DcimRearPortsTraceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
