...
func (o *PatchedWritableConsoleServerPortRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPatchedWritableConsoleServerPortRequest := _PatchedWritableConsoleServerPortRequest{}

	if err = json.Unmarshal(bytes, &varPatchedWritableConsoleServerPortRequest); err == nil {
