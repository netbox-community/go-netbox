...
// WithFamilyn adds the familyn to the ipam aggregates list params
func (o *IpamAggregatesListParams) WithFamilyn(familyn *string) *IpamAggregatesListParams {
	o.SetFamilyn(familyn)
	return o
}

// SetFamilyn adds the familyN to the ipam aggregates list params
func (o *IpamAggregatesListParams) SetFamilyn(familyn *string) {
	o.Familyn = familyn
}
