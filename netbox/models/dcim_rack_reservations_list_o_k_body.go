...
func (m *DcimRackReservationsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimRackReservationsListOKBody) validatePrevious(formats strfmt.Registry) error {
