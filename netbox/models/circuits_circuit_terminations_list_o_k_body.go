...
func (m *CircuitsCircuitTerminationsListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *CircuitsCircuitTerminationsListOKBody) validatePrevious(formats strfmt.Registry) error {
