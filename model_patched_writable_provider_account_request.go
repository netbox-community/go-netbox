...
func (o *PatchedWritableProviderAccountRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPatchedWritableProviderAccountRequest := _PatchedWritableProviderAccountRequest{}

	if err = json.Unmarshal(bytes, &varPatchedWritableProviderAccountRequest); err == nil {
