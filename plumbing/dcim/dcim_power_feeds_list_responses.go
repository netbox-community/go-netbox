...
type DcimPowerFeedsListOK struct {
	Payload *models.DcimPowerFeedsListOKBody
}
...
func (o *DcimPowerFeedsListOK) GetPayload() *models.DcimPowerFeedsListOKBody {
	return o.Payload
}
...
func (o *DcimPowerFeedsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DcimPowerFeedsListOKBody)
