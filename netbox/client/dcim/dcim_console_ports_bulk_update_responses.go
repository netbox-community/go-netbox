...
/*DcimConsolePortsBulkUpdateOK handles this case with default header values.
...
/*DcimConsolePortsBulkUpdateDefault handles this case with default header values.
