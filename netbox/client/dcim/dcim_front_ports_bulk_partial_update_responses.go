...
/*DcimFrontPortsBulkPartialUpdateOK handles this case with default header values.
...
/*DcimFrontPortsBulkPartialUpdateDefault handles this case with default header values.
