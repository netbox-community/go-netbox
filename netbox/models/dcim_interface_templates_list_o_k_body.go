...
func (m *DcimInterfaceTemplatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimInterfaceTemplatesListOKBody) validatePrevious(formats strfmt.Registry) error {
