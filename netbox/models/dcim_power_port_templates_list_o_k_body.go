...
func (m *DcimPowerPortTemplatesListOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *DcimPowerPortTemplatesListOKBody) validatePrevious(formats strfmt.Registry) error {
