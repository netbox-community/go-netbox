...
// WithFamilyn adds the familyn to the ipam ip addresses list params
func (o *IpamIPAddressesListParams) WithFamilyn(familyn *string) *IpamIPAddressesListParams {
	o.SetFamilyn(familyn)
	return o
}

// SetFamilyn adds the familyN to the ipam ip addresses list params
func (o *IpamIPAddressesListParams) SetFamilyn(familyn *string) {
	o.Familyn = familyn
}
...
func (o *IpamIPAddressesListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Familyn != nil {
		...
		// query param family__n
		var qrFamilyn string
		if o.Familyn != nil {
			qrFamilyn = *o.Familyn
		}
		qFamilyn := qrFamilyn
		if qFamilyn != "" {
			if err := r.SetQueryParam("family__n", qFamilyn); err != nil {
				return err
			}
		}
