...
func (o *PatchedWritableWirelessLANGroupRequest) UnmarshalJSON(bytes []byte) (err error) {
	varPatchedWritableWirelessLANGroupRequest := _PatchedWritableWirelessLANGroupRequest{}

	if err = json.Unmarshal(bytes, &varPatchedWritableWirelessLANGroupRequest); err == nil {
